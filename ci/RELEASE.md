...
card-back emblem on a purple-bordered card over waves, with ドン!!. It is an
adaptive icon with a themed variant, on the launcher, the splash and the
reminder notifications, which now show ドン!! in the status bar instead of
the phone's info icon. Nothing you have saved changes.
