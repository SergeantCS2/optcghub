...
design and refinement from take 104 on (the owner, 24 Sept; NSP). `main`
is take 104 (merged 02:13 UTC; Release take-104 02:19 with the APK, the
AAB and the mapping; build run 53 green; the last nightly, run 50,
green). Take 105 is the other session's open PR #29; this take follows
it and merges after it. This is the first of five UI takes (A42): the
