...
*Current as of take 96.* Paste the block between the rules into a new session
...
built across 96 takes by previous sessions. The repo is
...
Say "take 97" and begin with PROTOCOL §0.
