...
*Current as of take 101.* Paste the block between the rules into a new session
...
built across 101 takes by previous sessions. The repo is
...
Say "take 102" and begin with PROTOCOL §0.
