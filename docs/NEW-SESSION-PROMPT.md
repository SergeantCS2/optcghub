...
*Current as of take 97.* Paste the block between the rules into a new session
...
built across 97 takes by previous sessions. The repo is
...
Say "take 98" and begin with PROTOCOL §0.
