...
*Current as of take 100.* Paste the block between the rules into a new session
...
built across 100 takes by previous sessions. The repo is
...
Say "take 101" and begin with PROTOCOL §0.
