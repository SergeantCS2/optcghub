...
**Harness totals, take 97:** smoke.mjs 666 assertions, render.mjs 101 in
Chrome (three of them the Releases fold, the countdown colour and Remind
me), gate 23 checks with negative controls, hunt.py 61 selftest lines —
measured on the runner by the PR check (run 22); the session VM has no
